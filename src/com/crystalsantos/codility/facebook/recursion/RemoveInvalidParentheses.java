 ...
 * Constraints:
 * 
 * 1 <= s.length <= 25 s consists of lowercase English letters and parentheses
 * '(' and ')'. There will be at most 20 parentheses in s.
 * 
 */
public class RemoveInvalidParentheses {
	...
	private void run() {
		printResult(removeInvalidParentheses("()())()"));
		printResult(removeInvalidParentheses("(a)())()"));
		printResult(removeInvalidParentheses(")("));
	}
