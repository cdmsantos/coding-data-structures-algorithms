...
public class PrisonCellsAfterNDays {
	...
	public static void main(String[] args) {
		...
		prison.printResult(prison.prisonAfterNDays(new int[] { 0, 1, 0, 1, 1, 0, 0, 1 }, 28));
		prison.printResult(prison.prisonAfterNDays(new int[] { 1, 0, 0, 1, 0, 0, 1, 0 }, 1000000000));
	}
