...
public class NumberOfOneBits {
	...
	public static void main(String[] args) {
		...
		System.out.println(bits.hammingWeight(00000000000000000000000000001011)); // 3
		System.out.println(bits.hammingWeight(00000000000000000000000010000000)); // 1
//		System.out.println(bits.hammingWeight(11111111111111111111111111111101)); //31
	}
}
