 ...
 * Constraints:
 * 
 * 0 <= firstList.length, secondList.length <= 1000 firstList.length +
 * secondList.length >= 1 0 <= starti < endi <= 109 endi < starti+1 0 <= startj
 * < endj <= 109 endj < startj+1
 * 
 */
public class IntervalListIntersections {
	...
	public static void main(String[] args) {
		...
		intersection.printResult(
				intersection.intervalIntersection(new int[][] { { 0, 2 }, { 5, 10 }, { 13, 23 }, { 24, 25 } },
						new int[][] { { 1, 5 }, { 8, 12 }, { 15, 24 }, { 25, 25 } }));
		intersection.printResult(intersection.intervalIntersection(new int[][] { { 1, 3 }, { 5, 9 } }, new int[][] {}));
	}
