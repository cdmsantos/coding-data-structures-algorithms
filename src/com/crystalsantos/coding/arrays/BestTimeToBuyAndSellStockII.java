...
public class BestTimeToBuyAndSellStockII {
	...
	public static void main(String[] args) {
		BestTimeToBuyAndSellStockII stocks = new BestTimeToBuyAndSellStockII();
		System.out.println(stocks.maxProfit(new int[] { 7, 1, 5, 3, 6, 4 })); // 7
		System.out.println(stocks.maxProfit(new int[] { 7, 6, 4, 3, 1 })); // 0
		System.out.println(stocks.maxProfit(new int[] { 1, 2, 3, 4, 5 })); // 4
	}
}
